...
namespace DataverseModel
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseModel.BcGoV_ScheduleJob"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseModel.BcGoV_ScheduleJob> BcGoV_ScheduleJobSet
		{
			get
			{
				return this.CreateQuery<DataverseModel.BcGoV_ScheduleJob>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseModel.BcGoV_ScheduleJObsession"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseModel.BcGoV_ScheduleJObsession> BcGoV_ScheduleJObsessionSet
		{
			get
			{
				return this.CreateQuery<DataverseModel.BcGoV_ScheduleJObsession>();
			}
		}
	}
